...
var _default = React;
exports.default = _default;
},{"./create-element":"src/react/create-element.js"}],"src/react-dom/dom.js":[function(require,module,exports) {
"use strict";
...
function setAttribute(dom, key, value) {
  ...
  if (key === 'className') key = 'class'; // 如果属性是onXXX的形式,则说明是事件监听
  ...
  if (/^on\w+/.test(key)) {
    ...
    if (value && typeof value === 'string') {
      ...
      for (var name in value) {
        dom.style[name] = value[name]; // typeof value[name] === 'number' ? value[name] + 'px' : value[name]
      }
    } // 如果是普通属性,则直接更新
...
exports.default = _default;
},{"./dom":"src/react-dom/dom.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
function tick() {
  var element = _react.default.createElement("div", {
    className: "wrapper"
  }, _react.default.createElement("h3", null, "\u65F6\u95F4\uFF1A", new Date().toLocaleTimeString()));
